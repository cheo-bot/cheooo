...
* tq to jgn di hapus itu hasil kerja keras saya
**/
...
alasanafk = 'Nothing'
genderown = '♂️'
igcr1 = 'instagram.com/iamghosky_'
igcr2 = 'instagram.com/sofunsyabi.id'
grupct = 'https://chat.whatsapp.com/HECLovHbCI6LVVH4Q8FN2C'
sc = 'github.com/Cheo-bot/cheooo'
          	...
          	let found = false
                    for (let lmt of _limit) {
                        if (lmt.id === sender) {
                            ...
                            if (limitCounts <= 0) return denz.sendMessage(from,`Limit request anda sudah habis`, text,{ quoted: mek})
                            denz.sendMessage(from, ind.limitcount(limitCounts), text, { quoted : mek})
                            found = true
                        }
                    }
                    if (found === false) {
...
try {
		...
		const c = args.join(' ')
		var pes = (type === 'conversation8' && mek.message.conversation) ? mek.message.conversation : (type == 'imageMessage') && mek.message.imageMessage.caption ? mek.message.imageMessage.caption : (type == 'videoMessage') && mek.message.videoMessage.caption ? mek.message.videoMessage.caption : (type == 'extendedTextMessage') && mek.message.extendedTextMessage.text ? mek.message.extendedTextMessage.text : ''
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© C H E O_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"DON'T CLICK HERE",previewType:"PHOTO",thumbnail:ofrply,sourceUrl: `wa.me/6289653381067`}}})
		}
		const simir = (teks) => {
...
//memek//
        ...
        if (isGroup && isAntihidetag && m.message[m.mtype]?.contextInfo?.mentionedJid?.length ==
        groupMembers.length
    ) {
      console.log(
...
fill =`   ✘✘✘     ✘✘✘\n\nhi Kak *@${stod.split('@')[0]}* ${tampilUcapan}
...
"thumbnail": pporigi,}
,mentionedJid:[stod,otod,lntod]}, quoted : ftrol})
...
├ _Nama Owner : ${NamaOwner}_
├ _Nomor Owner : @${otod.split('@')[0]}_
├ _Gender Owner : ${genderown}_
├ _Auto Composing : ${settings.autocomposing}_
├ _Auto Recording : ${settings.autorecording}_
├ _Creator 2 : @${lntod.split('@')[0]}_
├ _Instagram Creator 1 : ${igcr1}_
├ _Instagram Creator 2 : ${igcr2}_
├ _Grup Chat : ${grupct}_
└❏
...
├─❒ DOWNLOAD
├ ${prefix}infogempa
├ ${prefix}herolist _Premium_
├ ${prefix}herodetail [ _hero_ ] _Premium_
├ ${prefix}google [ _search_ ]
├ ${prefix}gimage [ _search_ ]
├ ${prefix}wiki [ _search_ ]
├ ${prefix}mediafire [ _link_ ] _Premium_
├ ${prefix}ytsearch [ _judul_ ] _Premium_
├ ${prefix}ytmp4 [ _link yt_ ] _Premium_
├ ${prefix}ytmp3 [ _link yt_ ] _Premium_
├ ${prefix}play [ _judul lagu_ ] _Premium_
├ ${prefix}video [ _judul video_ ]
├ ${prefix}tinyurl [ _link_ ]
├ ${prefix}fetch [ _link_ ]
├ ${prefix}igdl [ _link_ ] _Premium_
├ ${prefix}tiktokdl [ _link_ ] _Premium_
...
├ ${prefix}twmp3 [ _link_ ] _Premium_
├ ${prefix}linkwa [ _search_ ]
├ ${prefix}fb [ _link_ ] _Premium_
...
├ ${prefix}Remm [ _teks_ ] _Premium_
├ ${prefix}lolim [ _teks_ ] _Premium_
├ ${prefix}gura [ _teks_ ] _Premium_
│
├──❒ GROUP
...
├ ${prefix}tictactoe [ _@tag_ ] _Premium_
├ ${prefix}delttt _Premium_
├ ${prefix}getpp
├ ${prefix}kick [ _@tag_ ]
├ ${prefix}add [ _nomor_ ]
├ ${prefix}getdeskgc
...
├ ${prefix}sticktag [ _nama sticker_ ] _Premium_
├ ${prefix}totag [ _reply media_ ]
│
├─❒ TOOLS
├ ${prefix}sticker
├ ${prefix}stickerwm [ _nama|author_ ] _Premium_
...
├ ${prefix}apakah
├ ${prefix}bisakah
├ ${prefix}caripesan [ _teks|jumlah_ ] _Premium_
├ ${prefix}slots
...
├ ${prefix}spamct [ _nomor|jumlah|teks_ ] _Premium_
└─────────────────❒
_*THANKS TO*_
*- _ALLAH SWT_*
*- _DCODE DENPA_*
...
denz.sendMessage(from, btnBngsat, MessageType.buttonsMessage, { quoted: ftrol, caption: menunya, contextInfo: { mentionedJid: [dtod,otod,lntod,stod]}})
                  }
break
...
if (isBan) return reply(mess.ban)
					...
					fs.unlinkSync(ranp)
					if (err) return reply(mess.emror.stick)
...
if (isBan) return reply(mess.ban)
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (isBan) return reply(mess.ban)
		 		if (!isUrl(args[0]) && !args[0].includes('tiktok.com')) return reply(mess.emror.api)
...
if (!isPrem) return reply(mess.prem)
            if (!c) return reply('Linknya?')
            if (!isUrl(args[0]) && !args[0].includes('facebook.com')) return reply(mess.emror.api)
            sticWait(from)
            te = args.join(' ')
            hx.fbdown(`${te}`)
            .then(G => {
...
└──────[ GITHUB ]──────❒
  ...
  │◦➛Script Recode : 
  │◦➛https://github.com/cheo-bot/cheooo
  └──────────────────❒`
 buttons = [
...
if(!isUrl(args[0]) && !args[0].includes('mediafire')) return reply(mess.emror.api)
...
if (err) return reply(mess.emror.api)
...
if (isBan) return reply(mess.ban)
  if (!isPrem)return reply(mess.prem)
   ...
   sticWait(from)
   bapakao = body.slice(6)
   sendMediaURL(from, `https://hardianto-chan.herokuapp.com/api/bot/rikka?apikey=hardianto&nama=${bapakao}`)
   break
case "neko":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (isBan) return reply(mess.ban)
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (isBan) return reply(mess.ban)
if (!isPrem) return reply(mess.ban)
	var imgbb = require('imgbb-uploader')
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
...
if (isBan) return reply(mess.ban)
				    ...
				    if (!c.includes('|')) return  reply(mess.emror.api)
...
if (!q.includes('tiktok')) return reply(mess.emror.Iv)
reply(mess.wait)
...
if (isBan) return reply(mess.ban)
                   ...
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
					...
					break
				case 'spam':
				if (!isGroup && !mek.key.fromMe) return sticOwner(from)
if (isBan) return reply(mess.ban)
if (!isPrem) return reply(mess.prem)
...
if (isBan) return reply(mess.ban)
    	   ...
    	   break
    	   case 'sc':
    	   reply(`github.com/cheo-bot/cheooo`)
    	   break
				case 'tag':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (isBan) return reply(mess.ban)
...
if (!isPrem) return reply(mess.prem)
						...
						if (!isLinks2) return reply(mess.emror.Iv)
						try {
							sticWait(from)
							ytv(args[0])
							.then((res) => {
								...
								sendFileFromUrl(dl_link, document, {mimetype: 'video/mp4', filename: `${title}.mp4`, quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:title,body:"🔖 YTMP4",mediaType:"2",thumbnail:getBuffer(thumb),sourceUrl:`${body.slice(7)}`}}}).catch(() => reply(mess.emror.api))
							})
							})
						} catch (err) {
							reply(mess.emror.api)
...
if (isBan) return reply(mess.ban)
              if (!isPrem) return reply(mess.prem)
						...
						if (!isLinks) return reply(mess.emror.Iv)
						try {
							sticWait(from)
							yta(args[0])
							.then((res) => {
								...
								sendFileFromUrl(dl_link, document, {mimetype: 'audio/mp3', filename: `${title}.mp3`, quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:title,body:"🔖 YTMP3",mediaType:"2",thumbnail:getBuffer(thumb),mediaUrl:`${body.slice(7)}`}}}).catch(() => reply(mess.emror.api))
							})
					        })
						} catch (err) {
							reply(mess.emror.api)
              ...
              if (!isPrem) return reply(mess.prem)
                            ...
                            try {
                                ...
                                .then((res) => {
                                    ...
                                    sendFileFromUrl(dl_link, document, {mimetype: 'audio/mp3', filename: `${title}.mp3`, quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:title,body:"🔖 PLAY MP3",mediaType:"2",thumbnail:getBuffer(thumb),mediaUrl:"https://youtu.be/Ejl9sLbgc1A"}}}).catch(() => reply(mess.emror.api))
                                    })
                                })
                            } catch (err) {
                                reply(mess.emror.api)
...
if (isBan) return reply(mess.ban)
                            ...
                            try {
                                ...
                                .then((res) => {
                                    ...
                                    sendFileFromUrl(dl_link, document, {mimetype: 'video/mp4', filename: `${title}.mp4`, quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:title,body:"🔖 PLAY MP4",mediaType:"2",thumbnail:getBuffer(thumb),sourceUrl:"https://youtu.be/Ejl9sLbgc1A"}}}).catch(() => reply(mess.emror.api))
                                    })
                                })
                            } catch (err) {
                                reply(mess.emror.api)
						...
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							await ffmpeg(`${media}`)
									...
									.on('end', function () {
										console.log('Finish')
										exec(`webpmux -set exif ./sticker/data.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
											if (error) return reply(mess.emror.api)
...
await denz.sendMessage(from, btngrass, MessageType.buttonsMessage, {quoted: ftrol})
			...
			if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				...
				break
				//autommek//
				if (budy.startsWith('@6289653381067')){

result = fs.readFileSync(`./sticker/anime/.webp`)

  denz.sendMessage(from, result, sticker, { quoted: mek })
                  }
            case 'babu':
              reply('hmm sy bukan babu')
              break
				case 'listrespon':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
teks = `\`\`\`「 LIST RESPON  」\`\`\`\n\n`

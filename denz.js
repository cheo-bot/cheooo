...
`
sendButDocument(from, `${menu}`, "*_© Cheo Bot_*", fs.readFileSync('./sampah/Denpa'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./media/image/banner.jpg'), filename:`Cheoo`, pagecount:`9999`, filesize:`99`},
[{buttonId:`allmenu`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`command`,buttonText:{displayText:'LIST MENU V2'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {quoted:fmen, contextInfo: { mentionedJid: [xyann,xyinnzz,xyan], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} ${pushname}`,body:`*click here to play music`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/uQiF1yOnzDg`}}})
break
case 'allmenu':
  xyan = `${sender}`
...
sendButDocument(from, `${menu}`, "*© Cheo BOT 乂 Xyann*", fs.readFileSync('./denz.js'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./media/image/banner.jpg'), filename:`Cheo - Bot`}, [

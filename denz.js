...
[{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {quoted:fmen, contextInfo: { mentionedJid: [xyann,xyinnzz,xyan], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} ${pushname}`,body:`*click here to play music`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/uQiF1yOnzDg`}}})
break
case 'allmenu':
  xyan = `${sender}`
 ...
 *Other Menu*
 ...
 sendButDocument(from, `${menu}`, "*_© Cheo Bot_", fs.readFileSync('./sampah/Denpa'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./media/image/banner.jpg'), filename:`Cheoo`, pagecount:`9999`, filesize:`99`,
[{buttonId:`Owner`,buttonText:{displayText:'Owner'},type:1}], quoted:fmen, contextInfo: { mentionedJid: [xyinnzz,xyan],forwardingScore: 508, isForwarded: true, "externalAdReply": {
"title": `hallo ${pushname}`,
"body": "Follow My Instagram, Click Here",
"previewType": "PHOTO",
"thumbnailUrl": `./media/image/me.jpg`,
"thumbnail": fs.readFileSync('./media/image/me.jpg'),
"sourceUrl": "instagram.com/iamghosky_"
}
}
});

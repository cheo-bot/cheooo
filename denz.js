...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Cheo Bot _*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© Cheo Bot_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
kma = doc1
pagecount = 99999
mhan = await denz.prepareMessage(from, media, document, kma, pagecount)
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Cheo Bot_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© Cheo Bot_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
╾ _Nomor Owner : @${xyinnzz.split('@')[0]}_
...
╾ _Nama : ${pushname}_
╾ _Bio : ${stst}_
╾ _Nomor : @${xyan.split('@')[0]}_
`
sendButImage(from, menu, "Created By Xyann", dmcok,
[{buttonId:`allmenu`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`command`,buttonText:{displayText:'LIST MENU V2'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}],"headerType": "DOCUMENT", "documentMessage": {
            "url": "https://instgram.com/iamghosky",
            ...
            "fileName": "Cheo Bot WhatsApp",
            "fileEncSha256": "NI9ykWUcXKquea4BmH7GgzhMb3pAeqqwE+MTFbH/Wk8=",
            "directPath": "/v/t62.7119-24/35160407_568282564396101_3119299043264875885_n.enc?ccb=11-4&oh=d43befa9a76b69d757877c3d430a0752&oe=61915CEC",
            "mediaKeyTimestamp": "1634472176",
            "jpegThumbnail": fs.readFileSync('./media/image/dmcok.jpg'), {quoted:fmen, contextInfo: { mentionedJid: [xyann,xyinnzz,xyan], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hai kaka ${pushname}`,body:`FOLLOW ME ON INSTGRAM`,mediaType:"2",thumbnail:ofrply,mediaUrl:`http://slynk.xyz/w9V`}}}}})
break
case 'allmenu':
  xyan = `${sender}`
...
sendButDocument(from, `${menu}`, "*© Cheo BOT 乂 Xyann*", fs.readFileSync('./denz.js'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./media/image/dmcok.jpg'), filename:`Cheo - Bot`}, [

          {
            ...
            type: 1,
                    ...
                    {
            buttonId: `${prefix}awikwoo`,
            buttonText: {
              displayText: `Script`,
            },
            type: 1,
          },
        ], { contextInfo: { mentionedJid: [xyan, xyinnzz], isForwarded: true, "externalAdReply": {
"title": `hallo ${pushname}`,
"body": "Follow Iamghosky_",
"previewType": "PHOTO",
"thumbnailUrl": `instagram.com/iamghosky_`,
"thumbnail": fs.readFileSync('./stik/me.jpg'),
"sourceUrl": "https://instagram.com/iamghosky_"}}});
			
			break
			case 'awikwoo':
			  reply('Usaha lah anjg')
			  break
case 'command':
 xyan = `${sender}`
 listMsg = {
 buttonText: 'LIST MENU',
 footerText: '*_© Cheo Bot_*',
 description: `Hai kak @${xyan.split('@')[0]}, Silahkan pilih menu disini`,
 sections: [
                     {
...
denz.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [xyan]},quoted:ftrol})
break
case 'ownermenu':
menu = `❏ 「 \`\`\`MENU OWNER\`\`\` 」
├────────────────────
...
case "logogaming":
   ...
   break
case 'donasi':
  xyannnnnz = `hai ${pushname} ini list donasi nya
  • Dana :
    -> 089653381067
  • Pulsa :
    -> 089653381067
  Kalo ingin donasi harap chat owner biar owner bisa tau\nregards by : @${xyinnzz.split('@')[0]}`
  break
case 'delcmd':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
break
		...
		case 'sc':
		case 'sourcecode':
		reply('base asli : Dcode Denpa\n -> http://github.com/dcode-denpa/bitch-boot\nRecode : Xyann\n -> Blom Upload :v')
		break
       case 'debug':
...
denz.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Follow instgram : @iamghosky_ ' })
fs.unlinkSync(ran)
})
case 'pinterest':
...
try {
    ...
    denz.groupAdd(from, i);
} catch (err) {
	denz.sendMessage(from, "```cannot find the group for given id```", MessageType.text);
}
break
				case 'status':
case 'stats':
